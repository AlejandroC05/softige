            ...
            <div class="col-md-6 col-sm-12 mb-3">
                ...
                <img src="/img/asesor.png" class="card-img-top" alt="Imagen de Moondance en Pixabay">
                    <div class="card-body bg-dark">
                        ...
                        <p class="card-text">Proporcionamos asesoramiento tecnológico para ayudarte a tomar decisiones informadas que impulsen tu negocio hacia el éxito.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-co mx-auto" style="width: 18rem;">
                ...
                <img src="/img/game.jpg" class="card-img-top" alt="Image by Freepik">
                    <div class="card-body bg-dark">
                        ...
                        <p class="card-text">Ofrecemos servicios de desarrollo de juegos que combinan creatividad, tecnología de vanguardia y un profundo conocimiento del mercado para producir juegos que cautiven y entretengan a los jugadores.</p>
                    </div>
                </div>
            </div>
        </div>
